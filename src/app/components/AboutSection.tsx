        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              ...
              love for creating seamless user experiences through code.
            </p>
          </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      Started my coding journey 2+ years ago with a simple
                      "Hello World" and never looked back. What began as
                      curiosity quickly transformed into a passion for creating
                      digital experiences that make a difference.
                    </p>
                    <p className="text-muted-foreground mb-6 leading-relaxed">
                      I specialize in React and Next.js, with a strong focus on
                      performance, accessibility, and user experience. When I'm
